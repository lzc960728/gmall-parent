package com.lzc.gmall.mock;

import com.alibaba.fastjson.JSON;
import com.alibaba.fastjson.JSONObject;
import com.lzc.gmall.mock.utils.RanOpt;
import com.lzc.gmall.mock.utils.RandomDate;
import com.lzc.gmall.mock.utils.RandomNum;
import com.lzc.gmall.mock.utils.RandomOptionGroup;
...
public class JsonMocker {
    ...
    //addFavor喜欢  addComment评论
    //addCart加入购物车  clickItem 点击  coupon 优惠券
    RanOpt[] eventOpts = {new RanOpt("addFavor", 10), new RanOpt("addComment", 15),
            new RanOpt("addCart", 20), new RanOpt("clickItem", 1),new RanOpt("coupon",40)
    };
